...
T =[]
for i in range(1,k):
    T.append(data.task_item(chr(65+(i%26)),2,1,i,24,0,1,"test",[""]))

P =[]
for i in range(1,k):
    P.append(data.period_item(i,9,12))
''''''
...
if __name__ == "__main__": # testing
    ...
    for i in range(1,6):
        ...
        print("pop()  :",timeit.timeit(stmt="test2()", setup="from __main__ import test2", number= 1))
